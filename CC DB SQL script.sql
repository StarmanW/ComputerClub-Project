...
--MEMBER TABLE
CREATE TABLE MEMBERS (MEMBERID VARCHAR(10) NOT NULL, PROGID VARCHAR(3) NOT NULL, FIRSTNAME VARCHAR(255) NOT NULL, LASTNAME VARCHAR(255) NOT NULL, EMAIL VARCHAR(200) NOT NULL, CONTACTNUM VARCHAR(20) NOT NULL, ICNUM VARCHAR(12) NOT NULL, PASS VARCHAR(255) NOT NULL, GENDER VARCHAR(1) NOT NULL, MEMFEESTATS BOOLEAN DEFAULT false  NOT NULL, "POSITION" INTEGER NOT NULL, ACADEMICYEAR VARCHAR(9) NOT NULL, PRIMARY KEY (MEMBERID));
INSERT INTO NBUSER.MEMBERS (MEMBERID, PROGID, FIRSTNAME, LASTNAME, EMAIL, CONTACTNUM, ICNUM, PASS, GENDER, MEMFEESTATS, "POSITION", ACADEMICYEAR) 
...
--COLLABORATOR TABLE
CREATE TABLE COLLABORATOR (COLLABID VARCHAR(10) NOT NULL, COLLABNAME VARCHAR(255) NOT NULL, COLLABTYPE INTEGER NOT NULL, CONTACTNO VARCHAR(20) NOT NULL, EMAIL VARCHAR(255), ADDITIONALNOTES VARCHAR(255), PRIMARY KEY (COLLABID));
