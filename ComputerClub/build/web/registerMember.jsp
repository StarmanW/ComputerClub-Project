...
<jsp:useBean id="programme" class="dataAccess.ProgrammeDA" scope="application"></jsp:useBean>
    <!DOCTYPE html>
    <html>
                                ...
                                <div class="col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <input type="text" name="fName" placeholder="Doe" class="form-control" pattern="[A-Za-z\-@ ]{2,}" title="Alphabetic, @ and - symbols only. E.g. - Smith" required="required">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label><span style="color:red;">*</span>IC Number</label>
                                            <input type="text" name="fName" placeholder="981213125523" class="form-control" pattern="\d{12}" title="Numeric only. E.g. 985564127789" required="required">
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label><span style="color:red;">*</span>Member ID</label>
                                            <input type="text" name="fName" placeholder="16SMD00990" class="form-control" pattern="^\d{2}[A-Z]{3}\d{5}$" title="E.g. 16SMD00990" required="required">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label><span style="color:red;">*</span>Contact Number</label>
                                            <input type="text" name="fName" placeholder="0195421325" class="form-control" pattern="([0-9]|[0-9\-]){3,20}" title="Numeric and '-' symbols only. E.g. 014-8897875" required="required">
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label><span style="color:red;">*</span>Email</label>
                                            <input type="email" name="fName" placeholder="email@hotmail.com" class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="E.g. - cisco@business.co.uk" required="required">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label><span style="color:red;">*</span>Programme Code</label>
                                            <select name="progCode" class="form-control" required="required">
                                                ...
                                                %>
                                                <option value="<%=progList.get(i).getProgCode()%>"><%=progList.get(i).getProgCode()%></option>
                                                <%}%>
                                            </select>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <select name="academicYear" class="form-control" required="required">
                                                ...
                                                <%
                                                    ...
                                                    for (int i = 0; i < 4; i++) {
                                                %>
                                                <option value="<%=year+i%>/<%=year+1+i%>"><%=year+i%>/<%=year+1+i%></option>
                                                <%}%>
                                            </select>
                                        </div>
                                    </div>
