...
<%
    ...
    if (eventID != null && !eventID.isEmpty()) {
        event = eventDA.selectRecord(eventID);
        session.setAttribute("eventToDelete", event);
    } else {
        session.removeAttribute("eventToDelete");  //Removing attribute, otherwise deletion still can be proceed from previous session
    }
%>
<!DOCTYPE html>
<html>
        ...
        <section class="cid-qEH6htC0aL mbr-fullscreen mbr-parallax-background" id="header2-19" data-rv-view="3101">
            <div class="container align-center">
                ...
                <div class="form-container">
                    <h1 class="well">Confirm Delete Event <%if (eventID != null && !eventID.isEmpty()) {%> <%=event.getEventID()%> <%}%></h1>
                    <hr style="border-top:1px solid gray;" />
                    <div class="col-lg-12 well">
                        <div class="row">
                            <form method="post" action="ProcessDeleteEvent">
                                <div class="row" style="margin:auto">
                                    <h5>Confirm delete event <%if (eventID != null && !eventID.isEmpty()) {%> <%=event.getEventID()%> (<%=event.getEventName()%>) <%}%> details? 
