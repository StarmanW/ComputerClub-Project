                            ...
                            <table class="table isSearch" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        %>
                                        <td class="body-item mbr-fonts-style display-7"><input type="checkbox" name="collabID" value="<%=collabList.get(i).getCollabID()%>" checked onclick="return false;"/>
                                            <form action="ProcessUpdateEventCollab" method="POST" style="display:inline">
                                                ...
                                                <button type="submit" name="delete" value="<%=collabList.get(i).getCollabID()%>" class="delete-button"><img src="assets/images/delete.png" /></button>
                                            </form>
                                        </td>
                                        ...
                                        <% if (!checkboxPrinted) {%>
                                        <td class="body-item mbr-fonts-style display-7"><input type="checkbox" name="collabID" value="<%=collabList.get(i).getCollabID()%>" onclick="return false;"/>
                                            <form action="ProcessUpdateEventCollab" method="POST" style="display:inline">
                                                <button type="submit" name="add" value="<%=collabList.get(i).getCollabID()%>" class="edit-button"><img src="assets/images/plus-square.svg" /></button>
                                                <button type="submit" name="delete" value="<%=collabList.get(i).getCollabID()%>" class="delete-button"><img src="assets/images/delete.png" /></button>
                                            </form>
