...
<html>
    ...
    <head>
        ...
        <title>Delete Event Status</title>
                        ...
                        <div class="row">
                            <form method="post" action="">
                                <div class="row" style="margin:auto">
                                    ...
                                    %>
                                    <h5>Event <%=event.getEventID()%> (<%=event.getEventName()%>) has been successfully deleted.</h5>
                                    <%} else {%>
                                    <h5>An error has occurred while deleting <%=event.getEventID()%><br />
                                        The errors are:<br/>
