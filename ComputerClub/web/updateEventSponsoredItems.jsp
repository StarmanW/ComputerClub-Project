                            ...
                            <table class="table isSearch" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        %>
                                        <td class="body-item mbr-fonts-style display-7"><input type="checkbox" name="itemID" checked value="<%=itemList.get(i).getItemID()%>" onclick="return false;"/>
                                            <form action="ProcessUpdateEventItem" method="POST" style="display:inline">
                                                ...
                                                <button type="submit" name="delete" value="<%=itemList.get(i).getItemID()%>" class="delete-button"><img src="assets/images/delete.png" /></button>
                                            </form>
                                        </td>
                                        ...
                                        <% if (!checkboxPrinted) {%>
                                        <td class="body-item mbr-fonts-style display-7"><input type="checkbox" name="itemID" value="<%=itemList.get(i).getItemID()%>" onclick="return false;"/>
                                            <form action="ProcessUpdateEventItem" method="POST" style="display:inline">
                                                <button type="submit" name="add" value="<%=itemList.get(i).getItemID()%>" class="edit-button"><img src="assets/images/plus-square.svg" /></button>
                                                <button type="submit" name="delete" value="<%=itemList.get(i).getItemID()%>" class="delete-button"><img src="assets/images/delete.png" /></button>
                                            </form>
