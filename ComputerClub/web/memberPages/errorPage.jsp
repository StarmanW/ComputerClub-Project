        ...
        <section class="cid-qEH6htC0aL mbr-fullscreen mbr-parallax-background" id="header2-19" data-rv-view="3101">
            <div class="container align-center">
                ...
                <div class="form-container">
                    <h1 class="well">Oops! An error has occurred.</h1>
                    <hr style="border-top:1px solid gray;" />
                    <div class="col-lg-12 well">
                        <div class="row">
                            <div class="row" style="margin:auto; text-align: center">
                                <h5 style="text-align: center">A HTTP Status 500 - Internal Server Error has occurred!</h5>
                                <p style="text-align: center;">Please contact the web administrator to resolve it. The error are describe as below: <br />
                                    <span style="font-weight: bold"><%=exception.getMessage()%></span>
                                </p>
                            </div>
                            <br />
                            <div class="submit-button">
                                <a href="homepage.jsp"><button type="button" class="btn btn-lg btn-info">Back to Home</button></a>
                            </div>
                        </div>
                    </div>
                </div>
